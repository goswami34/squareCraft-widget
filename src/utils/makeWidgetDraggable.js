export function makeWidgetDraggable(widgetContainer) {
    ...
    function moveAt(event) {
      ...
      newX = Math.max(0, Math.min(window.innerWidth - widgetContainer.offsetWidth, newX));
      newY = Math.max(0, Math.min(window.innerHeight - widgetContainer.offsetHeight, newY));
