...
// ✅ Declare global style cache map for shadow
const imageShadowStyleMap = new Map();

// ✅ Merge and Save Shadow Styles to DB
function mergeAndSaveImageShadowStyles(blockId, newStyles, saveFn) {
  const prevStyles = imageShadowStyleMap.get(blockId) || {
    image: {
  ...
  imageShadowStyleMap.set(blockId, finalData);
