            ...
            <div class="sc-items-center sc-gap-3  sc-flex">
               ...
               <div id="hover-bgColorSection" class=" ">
                  ...
                  <div class="sc-col-span-5 sc-mt-2 sc-z-99999 sc-relative ">
                     ...
                     <p id="hover-buttonBackgroundColorCode" class="sc-font-size-12 sc-roboto sc-universal">Select</p>
                     <div id="hover-buttonBackgroundColorPalateTriger" class="sc-square-6  sc-cursor-pointer"></div>
                     </div>
                     ...
                     <div class="sc-hover-button-backgroundcolor-arrow"></div>
                     ...
                     <div id="hover-color-code-toggle" class="sc-rounded-15px sc-px-2 sc-cursor-pointer sc-py-4px sc-bg-454545 sc-flex sc-items-center sc-gap-2">
                        <p id="hover-color-code-label" class="sc-universal sc-font-size-11 sc-roboto">RGB</p>
                        <span id="hover-color-code-arrow" class="sc-arrow-placeholder sc-rotate-180"></span>
                     </div>

                  <div id="hover-color-code-dropdown-list"
               ...
               <div id="hover-textColorSection" class=" ">
                  <p class="sc-font-size-11 sc-font-thin sc-mt-4 sc-universal sc-text-gray-300 sc-roboto">Text Color
                     ...
                     <div
                        class="sc-py-4px sc-relative sc-mt-2 sc-bg-3f3f3f sc-inActiveTab-border  sc-flex sc-justify-between sc-items-center sc-px-1 sc-rounded-4px hover-sc-button-text-color-palette">
                        <p class="sc-font-size-12 sc-roboto sc-font-light sc-universal">Select</p>
                        <div id="hover-button-text-color-select" class="sc-square-6  sc-cursor-pointer">
                        </div>
                        ...
                        <div id="hover-button-text-color-palette"
                           ...
                           <div class="sc-flex hover-color-h-selection sc-mt-2 sc-items-center sc-gap-2">
                              ...
                              <div id="hover-button-text-border-color-transparency-field"
                                 class="sc-h-full sc-w-3 sc-relative  sc-rounded-15px ">
                                 <div id="hover-button-text-border-color-transparency-bar"
                                    class="sc-absolute  sc-w-5 sc-left-half sc-shadow-sm sc-rounded-15px  sc-cursor-grabbing  sc-h-2 sc-bg-color-f2f2f2">
                                 </div>
                              </div>
                              <div id="hover-button-text-color-selection-field"
                                 class="sc-h-full sc-w-3 sc-relative sc-rounded-15px">
                                 <div id="hover-button-text-border-color-all-color-selction-bar"
                                    class="sc-absolute  sc-w-5 sc-left-half sc-shadow-sm sc-rounded-15px sc-cursor-grabbing sc-h-2 sc-bg-color-f2f2f2">
                                 </div>
                              </div>
                           </div>
                           <div
                              ...
                              <p id="hover-button-text-border-color-code" class="sc-font-size-12 sc-roboto sc-font-light sc-universal">Select
                              </p>
                              <p id="hover-button-text-border-color-transparency-count"
