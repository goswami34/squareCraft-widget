export function WidgetImageSection(id) {
  return `
      <div id="imageSection">
               ...
               <div id="backgroundColor" class="sc-color-section">
                  ...
                  <div class="sc-col-span-5 sc-mt-2 sc-z-99999 sc-relative">
                     ...
                     <div id="overLayFontColorPalate" class="sc-square-6 sc-border-colors sc-cursor-pointer" role="button" aria-label="Color picker"></div>
                     </div>
                     ...
                     <div class="sc-flex sc-items-center sc-justify-between">
                        <div id="overlay-border-colors" class="sc-flex sc-relative sc-items-center sc-gap-1" role="listbox" aria-label="Color swatches"></div>
                        <div class="sc-rounded-15px sc-px-1_5 sc-py-0_5 sc-bg-454545 sc-flex sc-gap-1">
                           <p class="sc-universal sc-font-size-11 sc-roboto">RGB</p>
                           <img id="buttonParagraph1Arrow" width="10" src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg" class="sc-rotate-180" alt="Toggle RGB">
                        </div>
                     </div>
                     <div class="sc-h-1px sc-mt-2 sc-bg-color-gray"></div>
                     <div class="sc-flex color-h-selection sc-mt-2 sc-items-center sc-gap-2">
