      ...
      <div id="imageSection">
               ...
               <div class="sc-flex sc-mt-4 sc-px-2">
                  <div id="borderButton"
                     ...
                     <h5 class="sc-roboto sc-font-thin sc-universal  sc-text-color-white">Border1111</h5>
               ...
               <div id="bgColorSection" class=" ">
                  ...
                  <div class="sc-col-span-5 sc-mt-2 sc-z-99999 sc-relative ">
                     ...
                     <div id="imageFontColorPalate" class="sc-square-6 sc-border-colors sc-cursor-pointer"></div>
                     </div>
                     <div id="image-font-color-palette"
                     ...
                     <div class="sc-flex sc-items-center sc-justify-between">
                        <div id="image-border-colors" class="sc-flex sc-relative sc-items-center sc-gap-1"></div>
                        <div class="sc-rounded-15px sc-px-1_5 sc-py-0_5 sc-bg-454545 sc-flex sc-gap-1">
