               ...
               <div id="overLaySection" class="sc-px-2 sc-mt-3">
                  <div class="sc-px-2 sc-flex sc-items-center sc-justify-between">
                     ...
                     <div class="sc-flex sc-cursor-pointer sc-items-center sc-rounded-15px sc-gap-2 sc-px-2 sc-py-0_5 sc-bg sc-bg-454545">
                        <p id="overlay-button-color-code" class="sc-font-thin sc-roboto sc-universal sc-text-xs">#363544</p>
                        <div id="overlay-button-border-colors" class="sc-square-6 sc-border-colors sc-cursor-pointer"></div>
                     </div>
                  </div>

                  <div id="overlay-buttonFontColorPalate" class="sc-absolute sc-hidden sc-border sc-border-solid sc-border-EF7C2F sc-top-12 sc-bg-3f3f3f sc-left-0 sc-p-1 sc-rounded-6px">
                     <div class="sc-color-arrow"></div>
                     <div class="sc-flex sc-items-center sc-justify-between">
                        <div id="overlay-button-all-color-selection-field" class="sc-flex sc-relative sc-items-center sc-gap-1">
                     ...
                     <div class="sc-h-1px sc-mt-2 sc-bg-color-gray"></div>
                     <div class="sc-flex color-h-selection sc-mt-2 sc-items-center sc-gap-2">
                        <div id="overlay-button-color-selection-field" class="sc-relative">
                     ...
                     <div class="sc-flex sc-justify-between sc-mt-3 sc-px-2 sc-py-0_5 sc-rounded-6px sc-bg-454545">
                        <p id="overlay-button-color-code" class="sc-text-sm sc-roboto sc-font-light sc-universal">#363544</p>
                        <p id="overlay-button-color-transparency-count" class="sc-text-sm sc-roboto sc-font-light sc-universal">100%</p>
                     </div>
                  </div>
               </div>
